...
//     public class CustomRenderModelHook : MonoBehaviour, IViveRoleComponent
//     {
//         public interface ICustomModel
//         {
//             void OnAfterModelCreated(CustomRenderModelHook hook);
//             /// <summary>
//             /// If from all components return true, hook will perform SetActive(true) on this model after this message
//             /// </summary>
//             bool OnBeforeModelActivated(CustomRenderModelHook hook);
//             /// <summary>
//             /// If from all components return true, hook will perform SetActive(false) on this model after this message
//             /// </summary>
//             bool OnBeforeModelDeactivated(CustomRenderModelHook hook);
//         }
//
...
//             protected CustomRenderModelHook hook { get; private set; }
//
//             public void Initialize(CustomRenderModelHook hook) { this.hook = hook; }
...
//
//         private static void SendAfterModelCreatedMessage(GameObject rootObj, CustomRenderModelHook hook)
//         {
...
//         }
//
//         private static bool SendBeforeModelActivatedMessage(GameObject rootObj, CustomRenderModelHook hook)
//         {
//             var result = true;
//             var iList = ListPool<ICustomModel>.Get(); try
//             {
...
//         }
//
//         private static bool SendBeforeModelDeactivatedMessage(GameObject rootObj, CustomRenderModelHook hook)
//         {
//             var result = true;
//             var iList = ListPool<ICustomModel>.Get(); try
//             {
