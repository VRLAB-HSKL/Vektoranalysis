...
{
    /// <summary>
    /// Klasse f�r die Erzeugung eines Quaders in x-Richtung eines rechtsh�ndigen Koordinatensystems.
    /// <remarks>
    /// Da wir das rechtsh�ndige Koordinaten in Unity (verwendet ein LHS) verwenden und die Pfad-Animation
    ...
    {
        /// <summary>
        /// Wir erzeugen f�r jedes Face des Quaders ein SubMesh.
        /// Auch das Material muss anschlie�end f�r jedes SubMesh erzeugt
        /// und zugewiesen werden. Das k�nnte verwendet werden um
        /// f�r jedes Face ein eigenes Material zu verwenden.
        ///
        /// Der Quader wurde von der Klasse Hexaeder abgeleitet und
        /// die x-Koordinaten wurden ver�ndert. Der Quader startet
        /// bei x=0 und endet bei x=1. Die y- und z-Koordinaten
        /// wurden verkleinert, da wir eine Achse visualisieren m�chten.
        /// </summary>
